  ...
  return (
    <div className=" mt-24 relative flex justify-end items-center">
      <div className=" flex items-center">
        <div className="pros bg-white w-1/2 left-0 z-10  p-8 rounded-2xl flex flex-col items-end text-right gap-10 absolute">
          <p className=" w-3/4">
      ...
      <div
        id="sec2-know-us"
        className=" items-end justify-end py-40 px-20 relative w-2/3 flex rounded-3xl"
      >
